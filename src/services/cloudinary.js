...
//   const cloudName = "huzaimaikram"; // Replace with your Cloudinary cloud name
//   const uploadPreset = "agency_data"; // Unsigned preset
...
//     const data = await res.json();
//     return data.secure_url; // ✅ URL to store in Firestore pdf array
//   } catch (error) {
